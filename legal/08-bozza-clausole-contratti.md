...
| C-5 | **Firma del wallet** (EIP-4361, "Sign-In with Ethereum") su un messaggio che contiene versione e hash | Collega l'accettazione al wallet che incassa o investe. Oggi `receipt_hash` è casuale |

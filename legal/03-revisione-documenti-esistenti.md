...
> **Sezione A applicata il 2026-09-15** su richiesta dell'utente, tenendo conto
> delle decisioni della stessa sera (annullamento per motivi di legge, 2%
> trattenuto, rimborso ai possessori dei token dopo la "phase 2", nessuna
> scadenza). Le sezioni B, C e D restano proposte. GitBook legge il whitepaper da
> `dev/cesare`, quindi il push lo pubblica.
...
| # | Dove | Testo originale | Problema | Correzione (✅ = applicata il 2026-09-15) |
|---|---|---|---|---|
...
| W-2 ✅ | cap. 6, ultimo paragrafo | *"No arbitration, no timeout, no one who can override it."* | Il Founder può cancellare la campagna e aprire i rimborsi (C-2). Il potere resta per decisione (§7.10) | *"No one can release a tranche on one side's say-so. The platform can, however, cancel a campaign on stated legal grounds — unlawful content or infringement of third-party rights. Cancellation stops all further releases, refunds the unreleased part pro rata, and leaves investors' claims against the artist for released tranches and damages intact."* Dal 2026-09-17 il potere è del Safe Owner (2 su 3), non più del Founder |
...
| W-12 ✅ | cap. 4, "What Humfiverse earns" | *"can only ever be sent to the platform's designated fee address"* | Il Founder può cambiare quell'indirizzo (`setFeeRecipient`) | *"…sent to the fee address the operator designates; every change of that address is a public on-chain event."* Dal 2026-09-17 il potere è del Safe Owner (2 su 3), non più del Founder |
| W-13 ✅ | cap. 2, punto 2 | *"Neither Humfiverse nor the artist can touch it early"* | Con raccolta parziale le prime tranche si possono rilasciare prima del raggiungimento dell'obiettivo; non ci sono scadenze (C-4, §2.86) | *"…released tranche by tranche as soon as enough has been raised to cover each one. Campaigns have no deadline: one ends when it sells out, releases everything, or is cancelled."* |
...
| W-19 | cap. 3, cap. 6, cap. 9 | Nessuna menzione dei versamenti di royalty on-chain né del multisig | Dal 2026-09-17 il token paga royalty, versate dall'artista o dalla Piattaforma per suo conto (il contratto le accetta da chiunque), ciascuna con l'impronta del file del rendiconto, pubblicabile a scelta di chi versa e comunque non verificato (§2.98); il proprietario dei contratti è un Safe 2 su 3 (02 C-9, C-12) | Aggiungere al cap. 3 come funzionano versamento e riscossione, chi versa, l'intervallo fissato per token e l'impronta del rendiconto (file pubblicabile), con il punto di fiducia (nessuno verifica rendiconto e importi, nessun obbligo on-chain di versare); al cap. 6 che i poteri del proprietario richiedono 2 firme su 3; al cap. 9 che i versamenti sulla rete di test sono in USDC senza valore |
| W-20 | cap. 2, diagramma; cap. 3; cap. 9 | *"Rights holder paid immediately (less the 2% platform fee)"* (correzione W-6) e, sul cap. 3, le royalty distribuite senza trattenuta | Falso dal 2026-09-17 (§2.101): la vendita diretta di un catalogo trattiene il **6%**, e ogni versamento di royalty il **1%** prima della distribuzione (02 C-15) | *"Rights holder paid immediately (less the 6% platform fee on a direct catalogue sale)."* Al cap. 3, sulle royalty: *"The platform keeps 1% of each deposit for running the distribution; the rest is shared equally over every token."* Se il capitolo elenca le aliquote, distinguere i due percorsi: vendita diretta 6% una tantum, campagna 2% + 3% per tranche (4,94% dell'obiettivo) |
...
| T-3 | `refund` | Rimborso *"ai token holder"* in caso di obiettivo mancato o milestone non consegnata | Il codice rimborsa chi ha contribuito, solo dopo una cancellazione del Founder, e trattiene il 2% (C-2, C-4, C-5, C-11) | Togliere i riferimenti a obiettivo mancato e ritardi: non ci sono scadenze, per decisione (§2.86). Descrivere il rimborso della parte non rilasciata dopo un annullamento e l'azione contro l'artista per il resto (§7.10). Testo pronto: file 08, clausole A-2 e A-3 **Il comportamento del codice è cambiato il 2026-09-17 (§2.97):** ora rimborsa chi possiede i token, con burn, come nella clausola A-2 del file 08 |
| T-4 | manca | **Nessuna clausola sulle commissioni** | Il 6% sulle vendite dirette, il 2% sui contributi, il 3% sulle tranche e l'1% su ogni versamento di royalty riducono ciò che l'artista riceve (§2.101) | Aggiungere una clausola dedicata con esempio numerico (il wizard mostra già il calcolo). Testo pronto: file 08, clausola A-6 |
...
| T-9 | manca | Dati del wallet che incassa e obbligo di custodirne la chiave | Il wallet decide dove vanno i soldi | Indicare il wallet nel testo accettato e registrarlo con l'accettazione (08, C-4 e C-5) |

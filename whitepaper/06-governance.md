...
It was redesigned. A milestone now only pays out once **both** the artist and the studio confirm it, independently, from their own wallets. There is no function anywhere in the contract — not even for Humfiverse's own operator role — that can release money on one side's say-so. If they disagree, the money stays in the escrow. No arbitration and no timeout. A campaign with no studio is the exception: the artist's confirmation alone releases it.

Humfiverse's role is limited to registering the artist and studio, setting up the campaign on agreed terms, and one power it deliberately keeps: **cancelling a campaign on stated legal grounds** — unlawful content, infringement of third-party rights, or false artist warranties about them — after notifying the artist and giving them 5 days to respond (a procedure still being built; the contract itself does not check the ground). That is a compliance takedown, not a judgment on whether anyone did their job. Cancelling stops all further releases, refunds the part not yet released, and leaves investors' claims against the artist for released money and damages intact.
